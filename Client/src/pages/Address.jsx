  ...
  return (
    <div className=''>
        <div className='bg-white shadow-lg px-2 py-2 flex justify-between gap-4 items-center '>
            ...
            <button onClick={()=>setOpenAddress(true)} className='border border-amber-400 text-amber-400 px-3 hover:bg-yellow-400 hover:text-black py-1 rounded-full cursor-pointer'>
                Add Address
            </button>
        </div>
